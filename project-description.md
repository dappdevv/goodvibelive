...
Технический стэк: TypeScript, React and Next.js, Supabase, React Hook Form, Zod, Zustand, TanStack React Query, Telegram web auth, Telegram Mini Apps, TON Connect UI, Wagmi (for TAC).
