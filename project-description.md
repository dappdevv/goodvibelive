...
Технический стэк: TypeScript, React and Next.js, Expo (React Native), Tamagui, Supabase, React Hook Form + Zod, Turbo (Monorepo Management), i18next (react-i18next, i18next, expo-localization), Zustand, TanStack React Query, Solito, Telegram web auth, Telegram Mini Apps, TON Connect UI, Wagmi (for TAC).
